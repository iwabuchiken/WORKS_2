...
REM ******************************
REM path_ws_others_jve
REM 	at : 2019/04/09 11:37:08
REM ******************************
) else if "%param%"==%path_ws_others_jve% (

	echo param is %path_ws_others_jve%!
...
rem : 2022年3月7日9:17:55 : start browser --> off
