...
REM start chrome.exe https://mail.google.com/mail/u/0/?shva=1#search/myself+d-17
REM start chrome.exe http://benfranklin.chips.jp/PHP_server/D-2/time_calc.php
start chrome.exe "http://benfranklin.chips.jp/PHP_server/D-2/url_encode_decode.php"
start chrome.exe "http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=des.&RBs_AND_OR_Memo=AND&sort=file_name&direction=desc"
