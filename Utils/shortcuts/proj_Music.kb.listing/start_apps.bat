...
start chrome.exe "https://docs.google.com/document/d/1WkTvX6eOad9sAwgYsOIgQ5aMxRbpA7lSQ8XY7eN-qpg/edit"
REM "Cake_IFM11"
start chrome.exe "http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_file_name=*&sort=file_name&direction=desc&filter_memo=kb&RBs_AND_OR_Memo=AND&RBs_AND_OR_File_Name=AND"
REM start chrome.exe "https://docs.google.com/document/u/0/"
start chrome.exe "https://docs.google.com/document/u/0/?q=kb%%20listing"
