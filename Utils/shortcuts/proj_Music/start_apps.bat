...
rem start chrome.exe http://www.zamzar.com/
...
REM pushd C:\WORKS_2\Programs\FreeMind
REM start FreeMind

REM pushd C:\WORKS_2\Programs\MuseScore_2.1\bin
REM start MuseScore
...
REM pushd "C:\Program Files\Mozilla Thunderbird"
REM TRM start thunderbird.exe
