...
rem start C:\WORKS_2\Utils\shortcuts\prog_SoundProg_in_C\"Command Prompt.lnk" /k a
...
:execute
start C:\WORKS_2\Utils\shortcuts\prog_ImageProg_in_C\"Command Prompt.lnk" /k %arg%
