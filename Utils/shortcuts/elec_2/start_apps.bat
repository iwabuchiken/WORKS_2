...
REM pushd C:\WORKS_2\Programs\Mikroelektronika\mikroC
REM start mikroC.exe

REM pushd "C:\WORKS_2\Programs\Microchip\PICkit 2_v2"
REM start PICkit2V2.exe

pushd "C:\Program Files (x86)\Pico Technology\PicoScope6"
start PicoScope.exe

REM pushd C:\WORKS_2\Programs\eclipse_kepler
REM pushd C:\WORKS_2\Programs\eclipse_luna_lisp
pushd C:\WORKS_2\Programs\eclipse_luna
start eclipse.exe

REM pushd C:\WORKS_2\Programs\Microchip\MPLAB_8.86\MPLAB IDE\Core
REM start MPLAB.exe
...
REM pushd C:\WORKS_2\Programs\Microchip\MPLABX\mplab_ide\bin
REM pushd C:\WORKS_2\Programs\Microchip\MPLAB\mplab_ide\bin
REM start mplab_ide --console suppress

REM pushd C:\WORKS_2\Programs\Arduino_1.6.5
REM start arduino
