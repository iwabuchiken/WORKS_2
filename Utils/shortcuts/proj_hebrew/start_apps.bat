...
start chrome.exe "https://mail.google.com/mail/u/0/?shva=1#search/ƒwƒuƒ‰ƒCŒê+myself+-daylog?compose=15a556deef3acd26"
start chrome.exe "http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=ƒwƒuƒ‰ƒCŒê&sort=file_name&direction=desc&RBs_AND_OR_Memo=AND"
start chrome.exe "https://ja.wikipedia.org/wiki/ƒwƒuƒ‰ƒCŒê"
