...
###############################
# if Eclipse is running => call the file "start_apps.no_eclipse.bat"
# if Eclipse is NOT running => call the file "start_command_prompot.bat"
###############################
...
#		printf("[%d] starting => %s\n", __LINE__, "start_apps");
		...
		my $res = `start C:/WORKS/Utils/shortcuts/prog_Maxima/start_apps.bat`;
